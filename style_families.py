...
FAMILIES: list[tuple[str, list[str], str, str, str]] = [
    ...
    (
        ...
        ["sour", "кисл", "гозе", "gose", "berliner", "берлинер", "берлинер вайссе",
         ...
         "фламандский", "flanders", "oulde bruin",
         "фламандский коричневый", "фламандский красный"],
        "🍋",
        "Кислые (Sour)",
        "Пива с заметной кислотностью: от освежающих гозе до десертных смузи-сауэров. "
        "Включая фламандские красные и коричневые эли.",
    ),
    (
        "stout",
    ...
    (
        "lager",
        ["lager", "лагер", "pilsner", "пилснер", "пизлнер", "pils", "helles", "хеллес",
         "бок", "bock", "dunkel", "дункель", "märzen", "мерцен", "шварц", "schwarz",
         "rausch", "райх", "kellerbier", "келлербир",
         "rauchbier", "копч", "festbier", "фестбир", "кёльш", "kolsh", "kölsch",
         "венский лагер", "vienna", "доппельбок", "doppelbock",
         "чешский пил", "чешский пиз"],
        "🪣",
        "Лагеры",
    ...
    (
        "belgian",
        ["belgian", "бельгий", "saison", "сейзон", "сэзон", "сельский эль", "farmhouse",
         "tripel", "трипл", "квадрюпель", "quadrupel", "quad", "trappist", "траппист",
         "abbey", "аббат", "dubbel", "дюббель", "blond ale", "блонд"],
        "🏆",
        "Бельгийские",
